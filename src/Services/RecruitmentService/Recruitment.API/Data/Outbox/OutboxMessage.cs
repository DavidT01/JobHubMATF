...
namespace Recruitment.API.Data.Outbox;
...
public sealed class OutboxMessage
{
    ...
    public static OutboxMessage Create(InterviewLifecycleEvent message) =>
        Create(message.EventId, message.InterviewScheduleId, message.EventType, message, message.OccurredAtUtc);

    public static OutboxMessage Create(CandidateProgressLifecycleEvent message) =>
        Create(message.EventId, message.CandidateProgressId, message.EventType, message, message.OccurredAtUtc);
